    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requires_sign_in', models.BooleanField(blank=True, default=False)),
                ('collect_identity', models.BooleanField(blank=True, default=False)),
            ],
        ),
        migrations.AddField(
            model_name='question',
            name='questionnaire',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='diafo.Questionnaire'),
        ),
        migrations.AddField(
